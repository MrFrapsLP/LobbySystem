...
Push-Runs ohne `game.py` im aktuellen Branch versuchen automatisch `game.py` aus `main` zu verwenden; wenn auch das fehlt, wird ein Hinweis-Build erzeugt, damit ein Artifact entsteht.
